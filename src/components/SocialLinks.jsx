...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/muhammad-ikhwan-manshur-3ba78a352?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@mhmmdikhwnmanshr",
    icon: Instagram,
    url: "https://www.instagram.com/mhmmdikhwnmanshr?igsh=MzQ3cG9ldGp2M3Ew",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@hanzwans5326",
    icon: Youtube,
    url: "https://www.youtube.com/@hanzwans5326",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@Xeno-Waan",
    icon: Github,
    url: "https://github.com/Xeno-Waan",
    color: "#ffffff",
  ...
  return (
    <div className="w-full bg-white/[0.02] border border-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      <h3
        ...
        data-aos="fade-down" 
      >
        <span className="inline-block w-8 h-1 bg-[#bfa37a] rounded-full"></span>
        Connect With Me
      </h3>
